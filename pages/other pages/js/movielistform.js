function upload(e) {
    ...
    let Movielist_detail = JSON.parse(localStorage.getItem('Movielist_detail')) || [];

    // hear we give some condition for uploading details to restict same unique id
    let exist = Movielist_detail.some(data =>
    ...
    if(!exist){
        ...
        Movielist_detail.push({movie_name,tamil,english,uuid});
