function upload(e) {
    ...
    let Trailer_detail = JSON.parse(localStorage.getItem('Trailer_detail')) || [];

    // hear we give some condition for uploading details to restict same unique id
    let exist = Trailer_detail.some(data =>
    ...
    if(!exist){
        ...
        Trailer_detail.push({movie_name,genre,language,dates,actors,director,music_Director,synopsis,image_link,link_file,timing,uuid});
